...
const SignUp = () => {
  ...
  const handleForm = async (e) => {
    ...
    try {
      ...
      navigate("/private/private-user-profil-form"); // Redirige l'utilisateur vers une page privée
    } catch (err) {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      await signInGoogle();
      navigate("/private/private-user-profil-form"); // Redirige vers une page privée après la connexion
    } catch (err) {
